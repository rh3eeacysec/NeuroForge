...
app.post('/api/user', (req, res) => {
  ...
  db.query(sql, [name, unique_id, agent_name, agent_img, agent_name, agent_img], (err, result) => {
...
app.get('/api/leaderboard', (req, res) => {
  const sql = 'SELECT u.name, u.unique_id, u.agent_name, SUM(s.total_xp) as total_xp FROM users u JOIN scores s ON u.unique_id = s.unique_id GROUP BY u.unique_id ORDER BY total_xp DESC LIMIT 10';
